...
![图10-17 Debug的表达式代码](../../.vuepress/public/images/book/expression/img/10-16.jpg)
...
在图10-19中的代码480行处，实际调用了`parseExpression`对表达式的解析，并将解析的返回结果作为getValue方法的入参，
...
![图10-22 Node接口的子类](../../.vuepress/public/images/book/expression/10-22.jpg)
...
![图10-25 Node接口的uml](../../.vuepress/public/images/book/expression/10-25.jpg)
